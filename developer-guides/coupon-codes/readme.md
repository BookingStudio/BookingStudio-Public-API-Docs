...
sequenceDiagram
    ...
    cl->>+v1: bookingOption:=</rest/v1/bookingoptions> @ <https://videodemo-api.bookingstudio.dk/rest/v1/docs.html#resource-bookingoptions>
    cl-->>w: bookingOption
    ...
    cl->>+ma: couponCodeReservationToken:=</api/admin/coupon-codes/redemptions/reserved (couponCode, bookingOption, reservationTimeInSeconds)> @ <https://videodemo-api.bookingstudio.dk/api/swagger/index.html#/Coupon%20Codes/ReserveCouponCodeForRedemption>
    ...
    w-->>cl: giftcardCode
    cl->>ma: validatedGiftCard:=</api/admin/gift-cards/codes/validate (giftcardCode)> @ <https://videodemo-api.bookingstudio.dk/api/swagger/index.html#/Gift%20cards/ValidateGiftCardCodes>
    ...
    cl->>+v1: <payRates:=/v1/payrates.xml (bookingOption)> @ <https://videodemo-api.bookingstudio.dk/rest/v1/docs.html#resource-bookingoptions>
    cl-->>w: payRates
    ...
    cl->>+v1: (reservationId, orderItemId):=</rest/v1/bookings/create.xml(bookingOption, couponCodeReservationToken, paymentAuthorizationToken, paymentAuthorizationAmount)> @ <https://videodemo-api.bookingstudio.dk/rest/v1/docs.html#resource-bookings>
    v1->>-c: quote 
    alt if with gift card redemption choosen
    loop for all giftcards giftcard
    cl->>+ma: </api/admin/gift-cards/apply (giftcard)> @ <https://videodemo-api.bookingstudio.dk/api/swagger/index.html#/Gift%20cards/ApplyGiftCardCodes>
